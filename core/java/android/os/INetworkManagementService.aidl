...
interface INetworkManagementService
{
    ...
    /**
     * Turn on Bluetooth Pan Nap service
     * Others TBD perhaps add Panu and Gn.
     */
    void startBtPanNap();
	
    /**
     * Turn off Bluetooth Pan service
     */
    void stopBtPan();
	
    /**
     * Check the status of Bluetooth Pan service
     */
    boolean isBtPanStarted();
	
    /**
     * Get list of connected remote Bluetooth Pan devices
     */
     String[] listBtPanConnections();
	
    /**
     * Connect remote Bluetooth Pan device
     */
    void connectBtPan(String adress, String role);
	
    /**
     * Disconnect remote Bluetooth Pan device
     */
    void disconnectBtPan(String adress);
