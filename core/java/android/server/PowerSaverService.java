...
public class PowerSaverService extends BroadcastReceiver {
    ...
    public void systemReady() {
        ...
        handler.postDelayed(new Runnable() {
            ...
            @Override
            public void run() {
                isCdma = (telephony.getPhoneType() == Phone.PHONE_TYPE_CDMA);
    ...
    private void setLowerPowerPhoneMode(boolean useLowerPower) {
        ...
        if (telephony.getPhoneType() == Phone.PHONE_TYPE_CDMA) {
            //telephony.toggleLTE(!useLowerPower);
        } else if (telephony.getPhoneType() == Phone.PHONE_TYPE_GSM) {
            //telephony.toggle2G(useLowerPower);
        }
    }
