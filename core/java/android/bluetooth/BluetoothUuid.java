...
public final class BluetoothUuid {
    ...
    public static boolean isPanUser(ParcelUuid uuid) {
        return uuid.equals(PANU);
    }
	
    public static boolean isNetworkAccessPoint(ParcelUuid uuid) {
        return uuid.equals(NAP);
    }

    public static boolean isGroupNetwork(ParcelUuid uuid) {
        return uuid.equals(GN);
    }
