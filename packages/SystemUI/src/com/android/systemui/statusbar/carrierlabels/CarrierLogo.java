 ...
 * SPN if available.
 */
public class CarrierLogo extends TextView {
    ...
    public CarrierLogo(Context context) {
        this(context, null);
    }

    public CarrierLogo(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CarrierLogo(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void updateSettings() {
        ...
        mCarrierLogo = (Settings.System.getInt(resolver,
