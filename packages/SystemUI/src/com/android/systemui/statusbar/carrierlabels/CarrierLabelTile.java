 ...
 * SPN if available.
 */
public class CarrierLabelTile extends TextView {
    ...
    public CarrierLabelTile(Context context) {
        this(context, null);
    }

    public CarrierLabelTile(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CarrierLabelTile(Context context, AttributeSet attrs, int defStyle) {
