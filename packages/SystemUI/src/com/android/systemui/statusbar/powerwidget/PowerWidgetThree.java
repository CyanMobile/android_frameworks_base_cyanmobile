...
public class PowerWidgetThree extends FrameLayout {
    private static final String TAG = "PowerWidgetThree";
    ...
    public PowerWidgetThree(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private class WidgetSettingsObserver extends ContentObserver {
        ...
        public void observe() {
            ...
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.EXPANDED_VIEW_WIDGET_GRID_THREE),
                            false, this);
        ...
        public void onChangeUri(Uri uri, boolean selfChange) {
            ...
            // now check if we change visibility
                ...
                updateVisibility();
            } else if(uri.equals(Settings.System.getUriFor(Settings.System.EXPANDED_VIEW_WIDGET_GRID_THREE))) {
                updateVisibility();
            } else if((uri.equals(Settings.System.getUriFor(Settings.System.EXPANDED_VIEW_WIDGET))) &&
                  (uri.equals(Settings.System.getUriFor(Settings.System.EXPANDED_VIEW_WIDGET_GRID_THREE)))) {
                updateVisibility();
