...
public class PowerWidgetTwo extends FrameLayout {
    private static final String TAG = "PowerWidgetTwo";
    ...
    private static final String BUTTONS_DEFAULT = PowerButton.BUTTON_BRIGHTNESS
                             ...
                             + BUTTON_DELIMITER + PowerButton.BUTTON_USBAP;
    ...
    static {
        ...
        sPossibleButtons.put(PowerButton.BUTTON_USBAP, UsbTetherButton.class);
        ...
        sPossibleButtons.put(PowerButton.BUTTON_SCREENSHOT, ScreenshotButton.class);
    ...
    public PowerWidgetTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private class WidgetSettingsObserver extends ContentObserver {
        ...
        public void observe() {
            ...
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.EXPANDED_VIEW_WIDGET_GRID_TWO),
                            false, this);
        ...
        public void onChangeUri(Uri uri, boolean selfChange) {
            ...
            // now check if we change visibility
                ...
                updateVisibility();
            } else if(uri.equals(Settings.System.getUriFor(Settings.System.EXPANDED_VIEW_WIDGET_GRID_TWO))) {
                updateVisibility();
            } else if((uri.equals(Settings.System.getUriFor(Settings.System.EXPANDED_VIEW_WIDGET))) &&
                  (uri.equals(Settings.System.getUriFor(Settings.System.EXPANDED_VIEW_WIDGET_GRID_TWO)))) {
                updateVisibility();
