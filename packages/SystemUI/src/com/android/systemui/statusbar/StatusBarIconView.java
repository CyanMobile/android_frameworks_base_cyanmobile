...
public class StatusBarIconView extends AnimatedImageView {
    ...
    public boolean set(StatusBarIcon icon) {
        ...
        if (!iconEquals) {
            ...
            if (drawable == null) {
                Slog.w(PhoneStatusBar.TAG, "No icon for slot " + mSlot);
                return false;
            }
    ...
    public static Drawable getIcon(Context context, StatusBarIcon icon) {
        ...
        if (icon.iconPackage != null) {
            try {
                ...
                Slog.e(PhoneStatusBar.TAG, "Icon package not found: " + icon.iconPackage);
                return null;
            }
        } else {
        ...
        try {
            ...
            Slog.w(PhoneStatusBar.TAG, "Icon not found in "
