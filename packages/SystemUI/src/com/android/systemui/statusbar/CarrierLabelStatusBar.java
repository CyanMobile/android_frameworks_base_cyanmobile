 ...
 * SPN if available.
 */
public class CarrierLabelStatusBar extends TextView {
    ...
    private boolean mStatusBarCarrier;
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(
                    ...
                    false, this);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.STATUS_BAR_STATUSBAR_CARRIER),
                    false, this);
    ...
    public CarrierLabelStatusBar(Context context) {
        this(context, null);
    }

    public CarrierLabelStatusBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CarrierLabelStatusBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    void updateSettings() {
        ...
        int mCarrierSizeval = Settings.System.getInt(resolver,
                Settings.System.STATUSBAR_CARRIER_FONT_SIZE, 10); // this value size for icon
