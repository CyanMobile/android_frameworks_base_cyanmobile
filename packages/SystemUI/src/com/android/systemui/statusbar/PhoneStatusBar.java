...
import com.android.systemui.batteries.CmBatteryMiniIcon;
import com.android.systemui.batteries.CmBatterySideBar;
import com.android.systemui.batteries.CmBatteryStatusBar;
import com.android.systemui.carrierlabels.CarrierLabel;
import com.android.systemui.carrierlabels.CarrierLabelBottom;
import com.android.systemui.carrierlabels.CarrierLabelExp;
import com.android.systemui.carrierlabels.CarrierLabelStatusBar;
import com.android.systemui.carrierlabels.CarrierLogo;
import com.android.systemui.carrierlabels.CenterCarrierLabelStatusBar;
import com.android.systemui.carrierlabels.CenterCarrierLogo;
import com.android.systemui.carrierlabels.LeftCarrierLabelStatusBar;
import com.android.systemui.carrierlabels.LeftCarrierLogo;
import com.android.systemui.clocks.CenterClock;
import com.android.systemui.clocks.Clock;
import com.android.systemui.clocks.LeftClock;
import com.android.systemui.clocks.PowerClock;
import com.android.systemui.clocks.ClockExpand;
import com.android.systemui.cmcustom.BackLogo;
import com.android.systemui.dates.DateView;
import com.android.systemui.dates.ExDateView;
import com.android.systemui.navbar.NavigationBarView;
import com.android.systemui.popups.BrightnessPanel;
import com.android.systemui.popups.QuickSettingsPopupWindow;
import com.android.systemui.popups.ShortcutPopupWindow;
import com.android.systemui.popups.WeatherPopup;
import com.android.systemui.powerwidget.PowerWidget;
import com.android.systemui.powerwidget.PowerWidgetBottom;
import com.android.systemui.powerwidget.PowerWidgetOne;
import com.android.systemui.powerwidget.PowerWidgetTwo;
import com.android.systemui.powerwidget.PowerWidgetThree;
import com.android.systemui.powerwidget.PowerWidgetFour;
import com.android.systemui.powerwidget.MusicControls;
import com.android.systemui.qwidgets.QwikWidgetsPanelView;
...
import com.android.systemui.policy.NetworkController;
import com.android.systemui.policy.PiePolicy;
import com.android.systemui.policy.StatusBarPolicy;
import com.android.systemui.policy.DataTraffics;
import com.android.systemui.pies.PieControlPanel;
import com.android.systemui.pies.PieExpandedView;
...
public class PhoneStatusBar extends SystemUI implements CommandQueue.Callbacks {
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            int defValue;
            int defValuesColor = mResources.getInteger(com.android.internal.R.color.color_default_cyanmobile);
            defValue=(CmSystem.getDefaultBool(mContext, CmSystem.CM_DEFAULT_BOTTOM_STATUS_BAR) ? 1 : 0);
            mBottomBar = (Settings.System.getInt(mResolver, Settings.System.STATUS_BAR_BOTTOM, defValue) == 1);
            defValue=(CmSystem.getDefaultBool(mContext, CmSystem.CM_DEFAULT_SOFT_BUTTONS_LEFT) ? 1 : 0);
            mButtonsLeft = (Settings.System.getInt(mResolver, Settings.System.SOFT_BUTTONS_LEFT, defValue) == 1);
            defValue=(CmSystem.getDefaultBool(mContext, CmSystem.CM_DEFAULT_USE_DEAD_ZONE) ? 1 : 0);
            mDeadZone = (Settings.System.getInt(mResolver, Settings.System.STATUS_BAR_DEAD_ZONE, defValue) == 1);
            mStatusBarCarrier = Settings.System.getInt(mResolver, Settings.System.STATUS_BAR_CARRIER, 6);
            mStatusBarClock = Settings.System.getInt(mResolver, Settings.System.STATUS_BAR_CLOCK, 1);
            mStatusBarCarrierLogo = Settings.System.getInt(mResolver, Settings.System.CARRIER_LOGO, 0);
            mStatusBarReverse = (Settings.System.getInt(mResolver, Settings.System.STATUS_BAR_REVERSE, 0) == 1);
            mShowCmBatteryStatusBar = (Settings.System.getInt(mResolver, Settings.System.STATUS_BAR_BATTERY, 0) == 5);
            mShowDate = (Settings.System.getInt(mResolver, Settings.System.STATUS_BAR_DATE, 0) == 1);
            mShowNotif = (Settings.System.getInt(mResolver, Settings.System.STATUS_BAR_NOTIF, 1) == 1);
            mShowRam = (Settings.System.getInt(mResolver, Settings.System.STATUS_BAR_SHOWRAM, 1) == 1);
            mShowIconex = (Settings.System.getInt(mResolver, Settings.System.STATUS_BAR_SHOWICONEX, 1) == 1);
            mShowCmBatterySideBar = (Settings.System.getInt(mResolver, Settings.System.STATUS_BAR_BATTERY, 0) == 4);
            mHasSoftButtons = (Settings.System.getInt(mResolver, Settings.System.USE_SOFT_BUTTONS, 0) == 1);
            LogoStatusBar = (Settings.System.getInt(mResolver, Settings.System.CARRIER_LOGO_STATUS_BAR, 0) == 1);
            shouldTick = (Settings.System.getInt(mResolver, Settings.System.STATUS_BAR_INTRUDER_ALERT, 1) == 1);
            mClockColor = (Settings.System.getInt(mResolver, Settings.System.STATUS_BAR_CLOCKCOLOR, defValuesColor));
            mSettingsColor = (Settings.System.getInt(mResolver, Settings.System.STATUS_BAR_SETTINGSCOLOR, defValuesColor));
            mStatusBarTab = (Settings.System.getInt(mResolver, Settings.System.EXPANDED_VIEW_WIDGET, 5) == 4);
            mStatusBarTile = (Settings.System.getInt(mResolver, Settings.System.EXPANDED_VIEW_WIDGET, 5) == 5);
            mStatusBarGrid = (Settings.System.getInt(mResolver, Settings.System.EXPANDED_VIEW_WIDGET, 5) == 3);
            mNaviShow = (Settings.System.getInt(mResolver, Settings.System.SHOW_NAVI_BUTTONS, 1) == 1);
            mTinyExpanded = (Settings.System.getInt(mResolver, Settings.System.STATUSBAR_TINY_EXPANDED, 1) == 1);
            mMoreExpanded = (Settings.System.getInt(mResolver, Settings.System.STATUSBAR_MORE_EXPANDED, 1) == 1);
            autoBrightness = Settings.System.getInt(mResolver, Settings.System.SCREEN_BRIGHTNESS_MODE, 0) ==
                    Settings.System.SCREEN_BRIGHTNESS_MODE_AUTOMATIC;
            mBrightnessControl = !autoBrightness && Settings.System.getInt(mResolver,
                    Settings.System.STATUS_BAR_BRIGHTNESS_TOGGLE, 0) == 1;
            IntruderTime = Settings.System.getInt(mResolver, Settings.System.STATUS_BAR_INTRUDER_TIME, INTRUDER_ALERT_DECAY_MS);
            mPieEnable = (Settings.System.getInt(mResolver, Settings.System.PIE_CONTROL_ENABLE, 1) == 1);
            mStatusBarHidden = (Settings.System.getInt(mResolver, Settings.System.STATUSBAR_ICONS_VISIBILITY, 0) == 1);
            updateColors();
            updateLayout();
            updateCarrierLabel();
            updateCarrierLogo();
    ...
    public void start() {
        ...
        if (sCurrentTheme != null) {
            mCurrentTheme = (CustomTheme) sCurrentTheme.clone();
        }
        ...
        mNetworkPolicy = new NetworkController(mContext);
        mPiePolicy = new PiePolicy(mContext);

        mResolver.registerContentObserver(
                Settings.System.getUriFor(Settings.System.PIE_GRAVITY), false, new ContentObserver(mHandler) {
                    @Override
                    public void onChange(boolean selfChange) {
    ...
    protected void makeStatusBarView() {
        ...
        mTouchDispatcher = new ItemTouchDispatcher(context);

        //Check for compact carrier layout and apply if enabled
        InitializeSettings();

        if (!mStatusBarTab && !mStatusBarTile) {
            mExpandedView = (ExpandedView) mInflater.inflate(R.layout.status_bar_expanded, null);
        } else {
            mExpandedView = (ExpandedView) mInflater.inflate(R.layout.status_bar_expandedtab, null);
        }
        mExpandedView.mService = this;
        mExpandedView.mTouchDispatcher = mTouchDispatcher;

        if (!mStatusBarReverse) {
            mStatusBarView = (CmStatusBarView) mInflater.inflate(R.layout.status_bar, null);
        } else {
            mStatusBarView = (CmStatusBarView) mInflater.inflate(R.layout.status_bar_reverse, null);
        }
        mStatusBarView.mService = this;

        mIntruderAlertView = (IntruderView) mInflater.inflate(R.layout.intruder_content, null);
        mIntruderAlertView.mService = this;
        mIntruderAlertView.mTouchDispatcher = mTouchDispatcher;
        mIntruderAlertView.setVisibility(View.GONE);

        mNavigationBarView = (NavigationBarView) mInflater.inflate(R.layout.navigation_bar, null);
        mNavigationBarView.mServices = this;
        mNaviBarContainer = (FrameLayout) mNavigationBarView.findViewById(R.id.navibarBackground);

        if (mNaviShow) {
            mWidgetsPanel = (QwikWidgetsPanelView) mInflater.inflate(R.layout.qwik_widgets_panel, null);
            mWidgetsPanel.setVisibility(View.GONE);

            mRingPanel = (RingPanelView) mInflater.inflate(R.layout.ring_widget_panel, null);
	...
	mMusicToggleButton = (ImageView) mExpandedView.findViewById(R.id.music_toggle_button);
        ...
        if (!mStatusBarTab && !mStatusBarTile) {
            mTrackingView = (TrackingView) mInflater.inflate(R.layout.status_bar_tracking, null);
        } else {
            mTrackingView = (TrackingView) mInflater.inflate(R.layout.status_bar_trackingtab, null);
        }
        ...
        mEdgeBorder = mResources.getDimensionPixelSize(R.dimen.status_bar_edge_ignore);
        mSelfExpandVelocityPx = mResources.getDimension(R.dimen.self_expand_velocity);
        mSelfCollapseVelocityPx = mResources.getDimension(R.dimen.self_collapse_velocity);
        mFlingExpandMinVelocityPx = mResources.getDimension(R.dimen.fling_expand_min_velocity);
        mFlingCollapseMinVelocityPx = mResources.getDimension(R.dimen.fling_collapse_min_velocity);

        mCollapseMinDisplayFraction = mResources.getFraction(R.dimen.collapse_min_display_fraction, 1, 1);
        mExpandMinDisplayFraction = mResources.getFraction(R.dimen.expand_min_display_fraction, 1, 1);

        mExpandAccelPx = mResources.getDimension(R.dimen.expand_accel);
        mCollapseAccelPx = mResources.getDimension(R.dimen.collapse_accel);

        mFlingGestureMaxXVelocityPx = mResources.getDimension(R.dimen.fling_gesture_max_x_velocity);

        // set the inital view visibility
        setAreThereNotifications();
        mDateView.setVisibility(View.INVISIBLE);
        showClock(Settings.System.getInt(mResolver, Settings.System.STATUS_BAR_CLOCK, 1) != 0);
        mVelocityTracker = VelocityTracker.obtain();
        mDoNotDisturb = new DoNotDisturb(context);
    }

    private void InitializeSettings() {
        int defValuesIconSize = mResources.getInteger(com.android.internal.R.integer.config_iconsize_default_cyanmobile);
        float mIconSizeval = (float) Settings.System.getInt(mResolver,
        ...
        mNaviShow = (Settings.System.getInt(mResolver, Settings.System.SHOW_NAVI_BUTTONS, 1) == 1);
        mTinyExpanded = (Settings.System.getInt(mResolver, Settings.System.STATUSBAR_TINY_EXPANDED, 1) == 1);
        mMoreExpanded = (Settings.System.getInt(mResolver, Settings.System.STATUSBAR_TINY_EXPANDED, 1) == 1);
        autoBrightness = Settings.System.getInt(mResolver, Settings.System.SCREEN_BRIGHTNESS_MODE, 0) ==
                    Settings.System.SCREEN_BRIGHTNESS_MODE_AUTOMATIC;
        mBrightnessControl = !autoBrightness && Settings.System.getInt(mResolver,
                            Settings.System.STATUS_BAR_BRIGHTNESS_TOGGLE, 0) == 1;
	...
	// apply transparent status bar drawables
        int transStatusBar = Settings.System.getInt(mResolver, Settings.System.TRANSPARENT_STATUS_BAR, 0);
        int statusBarColor = Settings.System.getInt(mResolver, Settings.System.STATUS_BAR_COLOR, defValuesColor());
        switch (transStatusBar) {
          case 0 : // theme, leave alone
            mStatusBarView.setBackgroundDrawable(mResources.getDrawable(R.drawable.statusbar_background));
            break;
          case 1 : // based on ROM
            mStatusBarView.setBackgroundDrawable(mResources.getDrawable(R.drawable.statusbar_background_black));
            break;
          case 2 : // semi transparent
            mStatusBarView.setBackgroundDrawable(mResources.getDrawable(R.drawable.statusbar_background_semi));
            break;
          case 3 : // gradient
            mStatusBarView.setBackgroundDrawable(mResources.getDrawable(R.drawable.statusbar_background_gradient));
            break;
          case 4 : // user defined argb hex color
            mStatusBarView.setBackgroundColor(statusBarColor);
            break;
          case 5 : // transparent
            mStatusBarView.setBackgroundDrawable(mResources.getDrawable(R.drawable.status_bar_transparent_background));
            break;
          case 6 : // transparent and BackLogo
               ...
               if (savedImage != null) {
                   ...
                   mBackLogoLayout.setBackgroundDrawable(mResources.getDrawable(R.drawable.statusbar_background_semi));
               }
            break;
        }

        // apply transparent navi bar drawables
        int transNaviBar = Settings.System.getInt(mResolver, Settings.System.TRANSPARENT_NAVI_BAR, 0);
        int naviBarColor = Settings.System.getInt(mResolver, Settings.System.NAVI_BAR_COLOR, defValuesColor());
        switch (transNaviBar) {
          case 0 : // theme, leave alone
            mNaviBarContainer.setBackgroundDrawable(mResources.getDrawable(R.drawable.navibar_background));
            break;
          case 1 : // based on ROM
            mNaviBarContainer.setBackgroundDrawable(mResources.getDrawable(R.drawable.navibar_background_black));
            break;
          case 2 : // semi transparent
            mNaviBarContainer.setBackgroundDrawable(mResources.getDrawable(R.drawable.navibar_background_semi));
            break;
          case 3 : // gradient
            mNaviBarContainer.setBackgroundDrawable(mResources.getDrawable(R.drawable.navibar_background_gradient));
            break;
          case 4 : // user defined argb hex color
            mNaviBarContainer.setBackgroundColor(naviBarColor);
            break;
          case 5 : // transparent
            mNaviBarContainer.setBackgroundDrawable(mResources.getDrawable(R.drawable.navibar_transparent_background));
            break;
          case 6 : // BackLogo
        ...
        if (mStatusBarCarrierLogo == 1) {
            if (LogoStatusBar) {
               ...
               mCarrierLogoLayout.setBackgroundDrawable(mResources.getDrawable(R.drawable.ic_statusbar_carrier_logos));
            }
            ...
            if (LogoStatusBar) {
               ...
               mCarrierLogoCenterLayout.setBackgroundDrawable(mResources.getDrawable(R.drawable.ic_statusbar_carrier_logos));
            }
            ...
            if (LogoStatusBar) {
               ...
               mCarrierLogoLeftLayout.setBackgroundDrawable(mResources.getDrawable(R.drawable.ic_statusbar_carrier_logos));
            }
        }
    }
    ...
    private void initializeItemExpand() {
        ...
        int transPowerAndCarrier = Settings.System.getInt(mResolver, Settings.System.TRANSPARENT_PWR_CRR, 0);
        int PowerAndCarrierColor = Settings.System.getInt(mResolver, Settings.System.PWR_CRR_COLOR, defValuesColor());
        switch (transPowerAndCarrier) {
          case 0 : // theme, leave alone
            mPowerAndCarrier.setBackgroundDrawable(mResources.getDrawable(R.drawable.title_bar_portrait));
            break;
        ...
        int transNotificationBackground = Settings.System.getInt(mResolver, Settings.System.TRANSPARENT_NOTIFICATION_BACKGROUND, 0);
        int notificationBackgroundColor = Settings.System.getInt(mResolver, Settings.System.NOTIFICATION_BACKGROUND_COLOR, defValuesColor());
        switch (transNotificationBackground) {
              case 0 : // theme, leave alone
                  mNotificationBackgroundView.setBackgroundDrawable(mResources.getDrawable(R.drawable.shade_bg));
                  break;
              case 1 : // default based on ROM
                  mNotificationBackgroundView.setBackgroundDrawable(mResources.getDrawable(R.drawable.shade_bg2));
                  break;
              ...
              case 3 : // semi transparent
                  mNotificationBackgroundView.setBackgroundDrawable(mResources.getDrawable(R.drawable.shade_trans_bg));
                  break;
              case 4 : // peeping android background image
                  mNotificationBackgroundView.setBackgroundDrawable(mResources.getDrawable(R.drawable.status_bar_special));
                  break;
        ...
        int transSettingsButton = Settings.System.getInt(mResolver, Settings.System.TRANSPARENT_STS_BTT, 0);
        int SettingsButtonColor = Settings.System.getInt(mResolver, Settings.System.STS_BTT_COLOR, defValuesColor());
        switch (transSettingsButton) {
          case 0 : // theme, leave alone
            mSettingsButton.setImageBitmap(getNinePatch(R.drawable.status_bar_close_on, getExpandedWidth(), getStatBarSize()));
            break;
          case 1 : // user defined argb hex color
            mSettingsButton.setImageBitmap(getNinePatch(R.drawable.status_bar_transparent_background, getExpandedWidth(), getStatBarSize()));
    ...
    private int defValuesColor() {
        return mResources.getInteger(com.android.internal.R.color.color_default_cyanmobile);
    }

    private void updateColors() {
        mItemText = Settings.System.getInt(mResolver, Settings.System.COLOR_NOTIFICATION_ITEM_TEXT, mBlackColor);
        mItemTime = Settings.System.getInt(mResolver, Settings.System.COLOR_NOTIFICATION_ITEM_TIME, defValuesColor());
        mItemTitle = Settings.System.getInt(mResolver, Settings.System.COLOR_NOTIFICATION_ITEM_TITLE, defValuesColor());

        mDateColor = Settings.System.getInt(mResolver, Settings.System.COLOR_DATE, defValuesColor());
        ...
        mButtonText = Settings.System.getInt(mResolver, Settings.System.COLOR_NOTIFICATION_CLEAR_BUTTON, mBlackColor);
        ...
        mNotifyNone = Settings.System.getInt(mResolver, Settings.System.COLOR_NOTIFICATION_NONE, defValuesColor());
        ...
        mNotifyTicker = Settings.System.getInt(mResolver, Settings.System.COLOR_NOTIFICATION_TICKER_TEXT, defValuesColor());
        mTickerText.updateColor(mNotifyTicker);

        mNotifyLatest = Settings.System.getInt(mResolver, Settings.System.COLOR_NOTIFICATION_LATEST, defValuesColor());
        mLatestTitle.setTextColor(mNotifyLatest);
        if (mStatusBarTab || mStatusBarTile) {
            mLatestTitles.setTextColor(mNotifyLatest);
        }

        mNotifyOngoing = Settings.System.getInt(mResolver, Settings.System.COLOR_NOTIFICATION_ONGOING, defValuesColor());
    ...
    private void updateSettings() {
        ...
        int changedVal = Settings.System.getInt(mResolver, Settings.System.EXPANDED_VIEW_WIDGET, 5);
    ...
    private void makeBatterySideBarViewLeft() {
        ...
        CmBatterySideBar batterySideBarLeft = (CmBatterySideBar) mInflater.inflate(R.layout.battery_sidebars, null);

        int width = mResources.getDimensionPixelSize(R.dimen.battery_sidebar_width);
    ...
    private void makeBatterySideBarViewRight() {
        ...
        CmBatterySideBar batterySideBarRight = (CmBatterySideBar) mInflater.inflate(R.layout.battery_sidebars, null);
    ...
    private int getNavBarSize() {
        int defValuesNaviSize = mResources.getInteger(com.android.internal.R.integer.config_navibarsize_default_cyanmobile);
        float navSizeval = (float) Settings.System.getInt(mResolver,
    ...
    private WindowManager.LayoutParams getNavigationBarLayoutParams() {
        ...
        final boolean sideways = (mNaviShow && (Settings.System.getInt(mResolver,
    ...
    private int getStatBarSize() {
        int defValuesStatsSize = mResources.getInteger(com.android.internal.R.integer.config_statbarsize_default_cyanmobile);
        float statSizeval = (float) Settings.System.getInt(mResolver,
    ...
    private void attachPies() {
        if(showPie()) {
            ...
            int gravity = Settings.System.getInt(mResolver,
    ...
    private void addPieInLocation(int gravity) {
        ...
        mPieControlPanel = (PieControlPanel) mInflater.inflate(R.layout.pie_control_panel, null);
        ...
        WindowManagerImpl.getDefault().addView(mPieControlsTrigger, getPieTriggerLayoutParams(gravity));
    ...
    public WindowManager.LayoutParams getPieTriggerLayoutParams(int gravity) {
        final float mPieSize = Settings.System.getFloat(mResolver,
                Settings.System.PIE_TRIGGER, 1f);
        WindowManager.LayoutParams lp = new WindowManager.LayoutParams(
              (gravity == Gravity.TOP || gravity == Gravity.BOTTOM ?
                    ViewGroup.LayoutParams.MATCH_PARENT : (int)(mResources.getDimensionPixelSize(R.dimen.pie_trigger_height)*mPieSize)),
        ...
        public void handleMessage(Message m) {
            switch (m.what) {
                ...
                case MSG_SHOW_WIDGETS_PANEL:
                    if (mWidgetsPanel != null && mNaviShow) {
                        mWidgetsPanel.show(true, false);
                    }
                    break;
                case MSG_HIDE_WIDGETS_PANEL:
                    if (mWidgetsPanel != null && mWidgetsPanel.isShowing() && mNaviShow) {
                        mWidgetsPanel.show(false, false);
                    }
                case MSG_SHOW_RING_PANEL:
                    if (mRingPanel != null && mNaviShow) {
                        mRingPanel.show(true);
                    }
                    break;
                case MSG_HIDE_RING_PANEL:
                    if (mRingPanel != null && mRingPanel.isShowing() && mNaviShow) {
    ...
    public boolean getDisabledExpanded() {
    ...
    public void animateCollapse() {
        ...
        performFling(y, -mSelfExpandVelocityPx, true);
    }
    ...
    private int getCloseDragHeight() {
        if (mStatusBarTab || mStatusBarTile) {
           return (mCloseView.getHeight() - (mMoreExpanded ? (mExpandedBottomToggle.getHeight() / 2) : 0));
        }
    ...
    private void performFling(int y, float vel, boolean always) {
        ...
        if (mExpanded) {
            if (!always &&
                    ((mBottomBar && (vel < -mFlingExpandMinVelocityPx || (y < 25 && vel < mFlingCollapseMinVelocityPx))) ||
                    (!mBottomBar && (vel > mFlingCollapseMinVelocityPx ||
                    (y > (mDisplayMetrics.heightPixels*(1f-mCollapseMinDisplayFraction)) && vel > -mFlingExpandMinVelocityPx))))) {
            ...
            if (always
                    || ( mBottomBar && (vel < -mFlingCollapseMinVelocityPx ||
                    (y < (mDisplayMetrics.heightPixels*(1f-mExpandMinDisplayFraction)) && vel < mFlingExpandMinVelocityPx)))
                    || (!mBottomBar && (vel >  mFlingExpandMinVelocityPx ||
                    (y > (mDisplayMetrics.heightPixels*(1f-mExpandMinDisplayFraction)) && vel > -mFlingCollapseMinVelocityPx)))) {
    ...
    private void adjustBrightness(int x) {
        float screen_width = (float)(mResources.getDisplayMetrics().widthPixels);
       ...
       try {
            ...
            if (power != null) {
                ...
                Settings.System.putInt(mResolver, Settings.System.SCREEN_BRIGHTNESS, newBrightness);
    ...
    private int getExpandedWidth() {
        int defValuesTinyExpSize = mResources.getInteger(com.android.internal.R.integer.config_tinyexpsize_default_cyanmobile);
        float expandedSizeval = (float) Settings.System.getInt(mResolver,
    ...
    private Bitmap getNinePatch(int id, int x, int y){
    ...
    private View.OnLongClickListener mSettingsButtonListener = new View.OnLongClickListener() {
        public boolean onLongClick(View v) {
            if (Settings.System.getInt(mResolver, Settings.System.ENABLE_SETTING_BUTTON, 0) == 1) {
                if (mFirstis) {
                    Settings.System.putInt(mResolver, Settings.System.NAVI_BUTTONS, 0);
                    mFirstis = false;
                } else {
                    Settings.System.putInt(mResolver, Settings.System.NAVI_BUTTONS, 1);
                    mFirstis = true;
                }
                animateCollapse();
                return true;
            } else if (Settings.System.getInt(mResolver, Settings.System.ENABLE_SETTING_BUTTON, 0) == 2) {
    ...
    private View.OnClickListener mCarrierButtonListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
             if(Settings.System.getInt(mResolver, Settings.System.EXPANDED_VIEW_WIDGET, 5) == 0) {
    ...
    private View.OnClickListener mIconButtonListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            if(Settings.System.getInt(mResolver, Settings.System.USE_CUSTOM_SHORTCUT_TOGGLE, 0) == 1) {
               if (mBrightnessControl) {
                   final View vW = v;
                   mHandler.postDelayed(new Runnable() {
                       @Override
    ...
    private class PieControlsTouchListener implements View.OnTouchListener {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (!mPieControlPanel.isShowing() && !getDisabledExpanded()) {
                switch(action) {
                    case MotionEvent.ACTION_DOWN:
                        centerPie = Settings.System.getInt(mResolver, Settings.System.PIE_CENTER, 1) == 1;
                        actionDown = true;
                        initialX = event.getX();
                        initialY = event.getY();
                        break;
    ...
    public void updateResources() {
        // detect theme change.
        CustomTheme newTheme = mResources.getConfiguration().customTheme;
        if (newTheme != null && (mCurrentTheme == null || !mCurrentTheme.equals(newTheme))) {
            ...
            if (mStatusBarTab || mStatusBarTile) {
               mLatestTitles.setText(mContext.getText(R.string.status_bar_latestnews_events_title));
            }
