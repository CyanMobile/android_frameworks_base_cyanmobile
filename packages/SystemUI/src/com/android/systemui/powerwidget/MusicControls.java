...
public class MusicControls extends FrameLayout {
    ...
    private PhoneStatusBar mSBService;
    ...
    public void updateControls() {
        ...
        mNowPlayingInfo.setTextColor(mClockColor);
        mAlbumArt = (ImageButton) findViewById(R.id.albumArt);

        if (mIsMusicActive && (Settings.System.getInt(resolver, Settings.System.MUSIC_WIDGET_TOGGLE, 1) == 1)) {
