...
public class UsbStorageActivity extends Activity
    ...
    private ImageView mMountButton;
    private ImageView mUnmountButton;
    private ProgressBar mProgressBar;
    private TextView mBanner1;
    private TextView mMessage1;
    private TextView mBanner2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBanner1 = (TextView) findViewById(com.android.internal.R.id.banner1);
        mMessage1 = (TextView) findViewById(com.android.internal.R.id.message1);
        mBanner2 = (TextView) findViewById(com.android.internal.R.id.banner2);
        mMessage2 = (TextView) findViewById(com.android.internal.R.id.message2);

        mMountButton = (ImageView) findViewById(com.android.internal.R.id.mount_button);
        mMountButton.setOnClickListener(this);
        mUnmountButton = (ImageView) findViewById(com.android.internal.R.id.unmount_button);
    ...
    private void switchDisplayAsync(boolean usbStorageInUse) {
        if (usbStorageInUse) {
            ...
            mUnmountButton.setImageResource(com.android.internal.R.drawable.usb_android_connected);
            mBanner2.setText(com.android.internal.R.string.usb_storage_stop_title);
            mMessage2.setText(com.android.internal.R.string.usb_storage_stop_message);
        } else {
            mProgressBar.setVisibility(View.GONE);
            ...
            mMountButton.setImageResource(com.android.internal.R.drawable.usb_android);
            mBanner1.setText(com.android.internal.R.string.usb_storage_title);
            mMessage1.setText(com.android.internal.R.string.usb_storage_message);
        }
    }
