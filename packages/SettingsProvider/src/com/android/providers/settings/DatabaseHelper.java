...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadUISoundEffectsSettings(SQLiteStatement stmt) {
        ...
        loadStringSetting(stmt, Settings.System.FULL_BATTERY_SOUND,
            R.string.def_full_battery_sound);
        loadStringSetting(stmt, Settings.System.CHARGING_BATTERY_SOUND,
            R.string.def_charging_battery_sound);
        loadStringSetting(stmt, Settings.System.DISCHARGING_BATTERY_SOUND,
            R.string.def_discharging_battery_sound);
