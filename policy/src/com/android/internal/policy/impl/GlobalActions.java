...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    private SilentModeAction mSilentModeToggle;
    ...
    private SinglePressAction mHibernate;

    private SinglePressAction mSuspend;
    ...
    private boolean mEnablePowerSaverToggle;
    private boolean mEnableScreenshotToggle;
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(
                    Settings.Secure.getUriFor(Settings.Secure.POWER_DIALOG_SHOW_POWER_SAVER), false, this);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.POWER_DIALOG_SHOW_SCREENSHOT), false, this);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.POWER_DIALOG_SHOW_HIBERNATE), false, this);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.POWER_DIALOG_SHOW_SUSPEND), false, this);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.POWER_DIALOG_SHOW_AIRPLANE), false, this);
            resolver.registerContentObserver(
    ...
    private AlertDialog createDialog() {
        mSilentModeToggle = new SilentModeAction(mAudioManager, mHandler);
        ...
        mProfile = new ProfileChooseAction() {
            public void onPress() {
                showProfileDialog();
            }
        ...
        // suspend
        mSuspend = new SinglePressAction(com.android.internal.R.drawable.ic_lock_power_off, R.string.global_action_suspend) {
           public void onPress() {
        ...
        // hibernate
        mHibernate = new SinglePressAction(com.android.internal.R.drawable.ic_lock_power_off, R.string.global_action_hibernate) {
           public void onPress() {
                // Starts the SuspendActivity which enables Device to enter deep sleep "hibernate2ram" state
                Intent intent = new Intent(Intent.ACTION_REQUEST_HIBERNATE);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                mContext.startActivity(intent);
           }
        ...
        // power off
        mPoweroff = new SinglePressAction(
    ...
    private void prepareDialog() {
        ...
        if (mEnableProfileToggle && !mItems.contains(mProfile)) {
           mItems.add(mProfile);
        };

        if (mEnablePowerSaverToggle && !mItems.contains(mPowerSaverOn)) {
