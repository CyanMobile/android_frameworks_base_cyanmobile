...
class ServerThread extends Thread {
    ...
    public void run() {
        ...
        BluetoothPanService bluetoothPan = null;
        ...
        try {
            ...
            try {
                ...
                reportWtf("starting Account Manager", e);
            }
            ...
            if (SystemProperties.get("ro.kernel.qemu").equals("1")) {
                ...
                bluetoothPan = new BluetoothPanService(context, bluetooth);
                ServiceManager.addService(BluetoothPanService.BLUETOOTH_PAN_SERVICE,
                                          bluetoothPan);
        ...
        if (factoryTest != SystemServer.FACTORY_TEST_LOW_LEVEL) {
            ...
            try {
                ...
                reportWtf("starting NetStat Service", e);
            }
            ...
            try {
                ...
                reportWtf("starting Profile Manager", e);
            }
            ...
            try {
                ...
                reportWtf("starting HeadsetObserver", e);
            }
            ...
            try {
                ...
                reportWtf("starting RingerSwitchObserver", e);
            }
            ...
            try {
                ...
                reportWtf("starting HDMIObserver", e);
            }
            ...
            try {
                ...
                reportWtf("starting Backup Service", e);
            }
            ...
            try {
                ...
                Slog.e(TAG,"failure starting PowerSaver service");
            }

            try {
                Slog.i(TAG, "GovernorService");
                cpuGovernorManager = new CpuGovernorService(context);
            } catch(Throwable e) {
                Slog.e(TAG,"failure starting Governor service");
            }
            ...
            if (SystemProperties.OMAP_ENHANCEMENT ) {
                if(SystemProperties.getBoolean("tv.hdmi.uicloning.enable", false)) {
                    try {
                        ...
                        reportWtf("starting UiCloningService", e);
                    }
                }
            }
        }
        ...
        ActivityManagerService.self().systemReady(new Runnable() {
            public void run() {
              ...
              try {
                ...
                reportWtf("making Ui Service ready", e);
              }
              ...
              try {
                ...
                reportWtf("making Power saver Service ready", e);
              }
              ...
              try {
                ...
                reportWtf("making Ime Service ready", e);
              }
