...
struct InputWindow {
    ...
    enum {
        ...
        TYPE_NAVIGATION_BAR     = FIRST_SYSTEM_WINDOW+15,
        TYPE_NAVIGATION_BAR_PANEL = FIRST_SYSTEM_WINDOW+16,
        TYPE_SECURE_SYSTEM_OVERLAY = FIRST_SYSTEM_WINDOW+17,
        TYPE_BOOT_PROGRESS      = FIRST_SYSTEM_WINDOW+18,
