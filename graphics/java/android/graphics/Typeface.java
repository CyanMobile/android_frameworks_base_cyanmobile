...
public class Typeface {
    ...
    /** The NORMAL style of the default open serif typeface. */
    public static final Typeface OPEN_SERIF;
    /** The NORMAL style of the default robo serif typeface. */
    public static final Typeface ROBO_SERIF;
    /** The NORMAL style of the default code serif typeface. */
    public static final Typeface CODE_SERIF;
    /** The NORMAL style of the default hindif typeface. */
    public static final Typeface HINDIF;
    /** The NORMAL style of the default motoya typeface. */
    public static final Typeface MOTOYA;
    ...
    static {
        ...
        OPEN_SERIF      = create("open-serif", 0);
        ROBO_SERIF      = create("robo-serif", 0);
        CODE_SERIF      = create("code-serif", 0);
        HINDIF          = create("hindi", 0);
        MOTOYA          = create("motoya", 0);
