...
public class RingtoneManager {
     ...
     * All types of sounds.
     */
    public static final int TYPE_ALL = TYPE_RINGTONE | TYPE_NOTIFICATION | TYPE_ALARM | TYPE_VIDEO;
    ...
    private static final String[] INTERNAL_VIDEO_COLUMNS = new String[] {
        ...
        "\"" + MediaStore.Video.Media.INTERNAL_CONTENT_URI + "/\" || " + MediaStore.Video.Media._ID,
    ...
    private int mType = TYPE_ALL_MEDIA;
    ...
    public Cursor getCursor() {
        ...
        return mCursor = new SortCursor(new Cursor[] {
            ...
            drmAudioCursor, mediaAudioCursor, mediaVideoCursor,
    ...
    private Cursor getThemeRegularRingtones() {
        if ((mType & TYPE_RINGTONE) != 0) {
            return query(Uri.parse("content://com.tmobile.thememanager.themes/themes"),
                    new String[] { "_id", "ringtone_name AS " + MEDIA_AUDIO_COLUMNS[1], "ringtone_uri",
                        "ringtone_name_key AS " + MEDIA_AUDIO_COLUMNS[3] },
                    getThemeWhereClause("ringtone_uri"), null, MEDIA_AUDIO_COLUMNS[3]);
        } else {
            return null;
        }
    }
    ...
    private Cursor getThemeNotificationRingtones() {
        if ((mType & TYPE_NOTIFICATION) != 0) {
            return query(Uri.parse("content://com.tmobile.thememanager.themes/themes"),
                    new String[] { "_id", "notif_ringtone_name AS " + MEDIA_AUDIO_COLUMNS[1], "notif_ringtone_uri",
                        "notif_ringtone_name_key AS " + MEDIA_AUDIO_COLUMNS[3] },
                    getThemeWhereClause("notif_ringtone_uri"), null, MEDIA_AUDIO_COLUMNS[3]);
        } else {
            return null;
        }
    }
